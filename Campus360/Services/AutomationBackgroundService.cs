...
namespace Campus360.Services
{
    ...
    /// </summary>
    public class AutomationBackgroundService : IDisposable
    {
        ...
        public AutomationBackgroundService(ILogger<AutomationBackgroundService> logger, IServiceProvider serviceProvider)
        {
            _logger = logger;
        ...
        public void StartAutomationChecks()
        {
            ...
            _logger.LogInformation("Automation Background Service started at: {time}", DateTimeOffset.Now);
            _isRunning = true;
        ...
        public void StopAutomationChecks()
        {
            ...
            _timer?.Dispose();
            _timer = null;
            _isRunning = false;            _logger.LogInformation("Automation Background Service stopped at: {time}", DateTimeOffset.Now);
        }
        ...
        public async Task StopAsync(CancellationToken stoppingToken)
        {
            ...
            // If base.StopAsync exists, call it; otherwise, remove this line
            // await base.StopAsync(stoppingToken);
        }
    }

    // Supporting models for background service
    ...
    public class ResultPublicationModel
    {
        public string StudentId { get; set; } = string.Empty;
        public string CourseId { get; set; } = string.Empty;
        public string CourseName { get; set; } = string.Empty;
